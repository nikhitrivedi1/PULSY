...
- **sleep_analysis()**: Returns a deep analysis of a user's sleep

### Knowledge Tools
- **get_Andrew_Huberman_Insights()**: Searches vector database of **only** Andrew Huberman podcast transcripts  
...
What does Andrew Huberman have to say about screens prior to going to sleep?
...
Source: Master_Your_Sleep_Be_more_Alert_when_Awake_copy.html, Text: You experience that. And if it's important enough, that becomes solidified a few days later. And you won't forget it. If it's unimportant, you'll probably forget it., Similarity: 0.438287765"
...
Your deep sleep duration was on the lower side of the recommended 1-1.5h. Considering you are 28 years old, you should aim to hit 1.5h of deep sleep every night. If you want to get more deep sleep, try to keep your sleep schedule consistent, and avoid heavy meals, stimulants and bright screens 1-2 hours before bed. [Andrew Huberman](sources/2023_Philanthropy__Evening_Routine__Light_Therapy__Health_Metrics___More.html)
...
I have detected a couple of concerning REM scores from December 11th to December 16th. REM is vital for your creativity and memory consolidation [Andrew Huberman](sources/Dr._Cal_Newport__How_to_Enhance_Focus_and_Improve_Productivity). According to Oura, the optimal range for REM sleep is between 1h and 1h 30m `<Oura Ring>`.
...
when asked to provide in-depth sleep analysis. Example queries can include the following:
"Provide an analysis of my sleep from yesterday"
"Can you provide a more in-depth analysis of my sleep from last week"

You might also need to call this function for more complex sleep metrics: 
" How did my bedtime vary last week?"
"How long was I in REM on 11/6?"

1. fetch sleep details using sleep_analysis()
2. identify any bad scors or noticable trends
3. utilize the `get_Andrew_Huberman_Insights()` to get insights on how to improve the bad scores
4. present all data in a highly structured format seperating data from the insights
